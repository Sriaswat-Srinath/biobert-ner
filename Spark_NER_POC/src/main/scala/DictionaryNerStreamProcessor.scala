// src/main/scala/DictionaryNerStreamProcessor.scala
// src/main/scala/DictionaryNerStreamProcessor.scala
...
object DictionaryNerStreamProcessor extends App {
  ...
  // *** FIX 1: Changed TextMatcher to TextMatcher (which is the actual class used for dictionary lookup) ***
  ...
  val parsedStream = rawKafkaStream
    ...
    // *** FIX 2: Switched to using col() for all column arguments in select ***
    .select(
      col("pmid"),
      col("raw_text"),
